...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Make sure it passes all tests, and add tests of your own.
...
GitLab pipelines will then deploy to PyPI if tests pass.
